...
const defaultTitles = [
  {id:0,text:'Photos',color:{light:'rgba(0,0,0,.84)',dark:'rgba(255,255,255,.95)'}},
  {id:1,text:'Videos',color:{light:'rgba(0,0,0,.84)',dark:'rgba(255,255,255,.95)'}},
...
const useClasses = themeHook({
  container:{
    ...
    height:'60px',
    borderBottom:({tldState}) => `2px solid ${(tldState === 'light') ? '#232323' : '#fff'}`,
