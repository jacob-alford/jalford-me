...
const getBorderColor = tldState => (tldState === 'light') ? "rgba(0,0,0,.87)" : 'rgba(255,255,255,1)';
  ...
  return (
    <Container className={classes.photoUploadHolder}>
      ...
      <Holder className={classes.fileUpload}>
        <input ref={formRef} type='file' accept="image/png, image/jpeg" name="photo" multiple/>
      </Holder>
    </Container>
  );
}
