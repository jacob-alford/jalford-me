							...
							<Grid
								...
								<Grid item>
									<Button
										...
										onClick={handleSnap}
										style={
											bodyHasChanged(true) ? styles.updateSnapshot : styles.disabledUpdateSnapshot
										}
										variant='outlined'>
										Snap
									</Button>
								...
								<Grid item>
									{isEditing ? (
										<IconButton onClick={preview} disabled={bodyHasChanged(true)}>
											<Visibility
												style={bodyHasChanged(true) ? { ...styles.icon, color: 'gray' } : styles.icon}
											/>
										</IconButton>
									) : (
									...
									<Grid item>
										<Grid spacing={2} container direction='column'>
											...
											<Grid item>
												<FormControlLabel
													control={
														<Switch checked={displayHeading} onChange={handleDisplayHeadingToggle} />
													}
